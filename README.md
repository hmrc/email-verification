...
|--------------|--------------------------------|-------------------|--------------------|--------------------|
| /send-code   | codesent@sendcode.com          |                   | CODE_SENT          | 200                |
| /send-code   | codenotsent@sendcode.com       |                   | CODE_NOT_SENT      | 400                |
| /send-code   | test@test                      |                   | CODE_NOT_SENT      | 400                |
| /verify-code | codesent@sendcode.com          | ABCDEF            | CODE_VERIFIED      | 200                |
| /verify-code | codenotverified@verifycode.com | FEDCBA            | CODE_NOT_VERIFIED  | 404                |
| /verify-code | invalidcodesent@sendcode.com   | 123456            | CODE_NOT_VALIDATED | 400                |
| /verify-code | codenotsent@sendcode.com       | test              | CODE_NOT_FOUND     | 404                |
